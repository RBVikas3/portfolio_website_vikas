          ...
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              ...
              <div>
                ...
                Highly motivated Front-end developer 1.2 years with a passion for crafting engaging UIs and backend architecture. Built and deployed 30 websites (personal + professional), proficient in React, Next.js, MongoDB, Node.js, jQuery, AWS, payment integrations (RezorPay, Stripe). Lead a 5-member team, skilled in communication and design. Eager to leverage my expertise for your team's success!
                </p>
